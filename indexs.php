...
//kode otomatis
$q = mysqli_query($koneksi, "SELECT kode FROM tbbarang order by kode desc limit 1");
...
if (isset($_POST['bsimpan'])) {
    ...
    if (isset($_GET['hal']) == "edit") {
        ...
        $edit = mysqli_query($koneksi, "UPDATE tbbarang SET
                                               nama = '$_POST[tnama]',
                                               nama_penerima = '$_POST[tnama_penerima]',
                                               asal = '$_POST[tasal]',
        ...
        $simpan = mysqli_query($koneksi, " INSERT INTO tbbarang (kode, nama, nama_penerima, asal, jumlah, satuan, tanggal_diterima)
                                            VALUE ( '$_POST[tkode]',
                                                    '$_POST[tnama]',                                         
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="tnama_penerima" value="<?= $vnama_penerima ?>" class="form-control"
                            ...
                            <div class="row">
                                ...
                                <div class="text-center">
                                    <hr>
                                    <button class="btn btn-danger" name="bsimpan" type="submit">Simpan</button>
                                    <button class="btn btn-primary" name="bkosongkan" type="reset">Kosongkan</button>
                                    <button class="btn btn-warning"><a href="index.php">Log out</a></button>
                                </div>
            ...
            <div class="card-body">
                ...
                <table class="table table-striped table-hover table-bordered">
                    ...
                    if (isset($_POST['bcari'])) {
                        ...
                        $keyword = $_POST['tcari'];
                        $q = "SELECT * FROM tbbarang WHERE kode like '%$keyword%' or nama like  '%$keyword%' or nama_penerima like '%$keyword%' or asal like '%$keyword%' order by id_barang desc  ";
                    } else {
                        $q = "SELECT * FROM tbbarang order by id_barang desc";
                    }
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="indexs.php?hal=edit&id=<?= $data['id_barang'] ?>" class="btn btn-warning">Edit</a>

                            <a href="indexs.php?hal=hapus&id=<?= $data['id_barang'] ?>" class="btn btn-danger"
